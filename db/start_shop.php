	...
	<tr>
	  <td><!-- InstanceBeginEditable name="Body" -->
	    <table>
          ...
          <tr>
            <td><table width="760" border="1" cellpadding="1" cellspacing="0">
                <tr bgcolor="#99CC33">
                ...
                <form action="<?php echo $editFormAction; ?>" method="post" name="form_new" id="form_new">
                  <tr>
                    ...
                    <td><?php list_shop_locations($ctrl_shoplocation,"East 5th Ave") ?></td>
              ...
              <?php } else { // end if EDIT RECORD ?>
                <tr>
                  ...
                  <td><?php echo $row_Recordset1['num_visitors']; ?> Visitors<br />
                    ~<?php echo $row_Recordset1['total_hours']; ?> Hours</td>
                  <td><?php echo "<a href=\"{$_SERVER['PHP_SELF']}?shop_date={$shop_date}&shop_id={$row_Recordset1['shop_id']}\">edit</a>"; ?></td>
                </tr>
                <?php
		  } // end if EDIT RECORD 
