...
<!--
 function getgoing()
  {
    top.location="http://db.thirdhand.org/shop_log.php?" + location.search.substring(1);
   }
...
<body>
<table width="760" border="0" align="center" cellpadding="1" cellspacing="0" class="yb_standardCENTER">
  <tr>
    <td height="900" valign="top"><p class="yb_standardCENTERred">First-time sign in almost complete </p>
      ...
      <p><strong>The Third Hand Bicycle Cooperative - Monthly Newsletter </strong></p>
...
<p>&nbsp;</p>
<IFRAME SRC="http://groups.google.com/group/third-hand-bicycle-cooperative/boxsubscribe?email=<?php echo $email;?>" WIDTH=760 HEIGHT=500>
</IFRAME>
