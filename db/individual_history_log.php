  ...
  <tr>
	...
	<form method="post" name="FormUpdate_<?php echo $row_Recordset1['shop_visit_id']; ?>" action="<?php echo $editFormAction; ?>">
	  <tr bordercolor="#CCCCCC">
		...
		<td>
			<?php echo "<a href=\"{$_SERVER['PHP_SELF']}?contact_id={$contact_id}&visit_id={$row_Recordset1['shop_visit_id']}\">edit</a>"; ?>
			<!-- <a href="users/process.php?action=delete_history_entry&shop_visit_id=<?php echo $row_Recordset1['shop_visit_id']; ?>">  Delete</a> //-->
		</td>
	  </tr>
